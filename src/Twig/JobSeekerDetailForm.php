...
#[AsLiveComponent(template: 'components/jobSeeker-detail.html.twig')]
class JobSeekerDetailForm extends AbstractController
{
    ...
    protected function instantiateForm(): FormInterface
    {
        return $this->createForm(
            JobSeekerDetailsType::class,
            $this->user->getJobSeekerDetails(),
        );
    }
}
