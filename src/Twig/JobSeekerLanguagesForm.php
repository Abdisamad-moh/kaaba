...
use App\Form\JobSeekerLanguagesFormType;
...
#[AsLiveComponent(template: 'components/jobSeeker-language.html.twig')]
class JobSeekerLanguagesForm extends AbstractController
{
    ...
    public function save(Request $request)
    {
        ...
        foreach($this->getForm()->get('jobSeekerLanguages')->getData() as $language) 
        {
    ...
    protected function instantiateForm(): FormInterface
    {
        return $this->createForm(
            JobSeekerLanguagesFormType::class,
            $this->user
        );
    }
}
