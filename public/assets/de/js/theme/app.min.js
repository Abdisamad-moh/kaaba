...
//   const INACTIVITY_LIMIT = 20 * 1000; // 20 seconds in milliseconds
...
//       fetch('/api/session-lifetime')
//           .then(response => response.json())
//           .then(data => {
//               const cookieLifetime = data.cookie_lifetime * 1000; // Convert seconds to milliseconds
//               const sessionExpiration = new Date().getTime() + cookieLifetime;

//               const currentTime = new Date().getTime();
//               if (currentTime >= sessionExpiration) {
//                   alert('Your session has expired.');
//                   // Handle session expiration (e.g., redirect to logout or show a message)
//                   window.location.href = '/logout'; // Adjust to your logout route
//               } else {
//                   // Optionally show remaining time
//                   const remainingTime = sessionExpiration - currentTime;
//                   alert(`Session will expire in ${Math.ceil(remainingTime / 1000)} seconds.`);
//               }
//           })
//           .catch(error => console.error('Error fetching session lifetime:', error));
//   }
